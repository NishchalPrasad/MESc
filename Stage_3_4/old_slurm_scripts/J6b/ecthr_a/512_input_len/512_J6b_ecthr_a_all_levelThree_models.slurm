#!/bin/bash
#SBATCH --job-name=512_GPTJ6b_ecthr_a       # name of job
...
#SBATCH --output=LEGAL-PE/Level-3_of_Framework/slurm_scripts/J6b/ecthr_a/512_GPTJ6b_ecthr_a%j.out    # name of output file
#SBATCH --error=LEGAL-PE/Level-3_of_Framework/slurm_scripts/J6b/ecthr_a/512_GPTJ6b_ecthr_a%j.out     # name of error file (here, in common with the output file)
